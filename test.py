...
model.load_weights('./Weight/pggan_efficientnetb1_trained_weights.h5')

# Read CSV
train_df_main_agmented = pd.read_csv('./Data/pggan_main_df.csv', index_col=0)
train_df_main = pd.read_csv('./Data/train_df_main.csv', index_col=0)
test_df_main = pd.read_csv('./Data/test_df.csv', index_col=0)
