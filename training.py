...
train_df_main = pd.read_csv('./Data/train_val_df.csv', index_col=0)
...
using_data, _ = train_test_split(train_df_main, test_size = 0.4, random_state = 1993)
train_set, valid_set = train_test_split(_, test_size = 0.2, random_state = 1993)
# train_set, valid_set = train_test_split(train_df_main, test_size = 0.2, random_state = 1993)
# test_set = test_df
...
pd.DataFrame.from_dict(history.history).to_csv('smaple_history.csv', index = False)